...
execute if entity @s[tag=toggle_open] run function mnaf:guard_door/common/door/open
execute if entity @s[tag=toggle_close] run function mnaf:guard_door/common/door/close
