...
summon armor_stand ~ ~ ~ {Rotation:[0f,0f],NoGravity:1b,Invulnerable:1b,Invisible:1b,ShowArms:1b,NoBasePlate:1b,Tags:["salvage_animatronic","salvage_ai","salvage_chica","unset_salvage"],CustomName:'"Salvage Chica"'}
