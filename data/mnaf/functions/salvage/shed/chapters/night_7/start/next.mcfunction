...
advancement revoke @a[tag=run_salvage_shed] only mnaf:salvage_shed/night/7/start current
advancement grant @a[tag=run_salvage_shed,tag=!salvage_skip] only mnaf:salvage_shed/night/7/1