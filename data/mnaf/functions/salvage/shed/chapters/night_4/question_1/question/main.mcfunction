...
execute as @a[tag=run_salvage] at @s run playsound mnaf:salvage.night_4.2 voice @s
tag @e[tag=salvage_animatronic] add salvage_active
tag @e[tag=salvage_animatronic] add can_tase

schedule function mnaf:salvage/shed/chapters/night_4/question_1/question/1 11s
