...
# Taze to reset
execute at @e[tag=salvage_button_taze] if block ~ ~ ~ #minecraft:buttons[powered=true] as @e[tag=salvage_animatronic] run function mnaf:salvage/shed/animatronic/reset
