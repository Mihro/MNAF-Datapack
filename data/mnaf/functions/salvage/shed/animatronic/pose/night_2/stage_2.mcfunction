execute as @e[tag=salvage_animatronic,tag=salvage_shed] run data merge entity @s {Pose:{Head:[0f,0f,37f],LeftLeg:[270f,351f,0f],RightLeg:[266f,0f,0f],LeftArm:[297f,0f,0f],RightArm:[282f,0f,0f]}}
