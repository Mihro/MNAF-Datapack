...
execute if entity @s[tag=salvage_foxy  ] as @e[tag=salvage_foxy_marker  ] if score @s SalvageAIMarker = target SalvageAIMarker at @s as @e[tag=salvage_ai,tag=salvage_foxy  ] run function mnaf:salvage/ai/animatronic/foxy/move_to_marker
