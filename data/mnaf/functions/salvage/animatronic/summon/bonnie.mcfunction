...
execute at @e[tag=salvage_root] run summon armor_stand ~ ~ ~ {Rotation:[90f,0f],NoGravity:1b,Invulnerable:1b,Invisible:1b,ShowArms:1b,NoBasePlate:1b,Tags:["salvage","salvage_animatronic","unset_salvage"]}
