execute as @e[tag=salvage_animatronic] run data merge entity @s {Pose:{Head:[24f,0f,0f],LeftLeg:[271f,337f,0f],RightLeg:[273f,8f,0f],LeftArm:[329f,0f,0f],RightArm:[314f,0f,0f]}}
