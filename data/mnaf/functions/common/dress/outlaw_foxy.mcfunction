...
execute if entity @s[type=armor_stand] run data merge entity @s {CustomName:'"Outlaw Foxy"',DisabledSlots:4144896,Invisible:1b,Invulnerable:1b,Marker:1b,NoBasePlate:1b,NoGravity:1b,ShowArms:0b,Tags:["animatronic","cowpoke_freddy"]}
